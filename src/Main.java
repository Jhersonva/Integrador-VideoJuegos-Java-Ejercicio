...
public class Main {
    ...
    public static void main(String[] args) throws VideoJuegoNoEncontradoException {
        ...
        while (opcion != 4) {
            ...
            if (opcion == 1) {
                // Opción 1: Agregar un nuevo videojuego
                System.out.println("Agregue el número de código: ");
                codigo = teclado1.nextInt();
                teclado1.nextLine(); // Consumir el salto de línea pendiente
                System.out.println("Ingrese el nombre del título: ");
                titulo = teclado2.nextLine(); // Lee el título del videojuego
                System.out.println("Ingrese el tipo de consola: ");
                consola = teclado2.nextLine(); // Lee el tipo de consola
                System.out.println("Ingrese la cantidad de jugadores: ");
                cantidadJugadores = teclado1.nextInt(); // Lee la cantidad de jugadores
                teclado1.nextLine(); // Consumir el salto de línea pendiente
                System.out.println("Ingrese la categoría: ");
                categoria = teclado2.nextLine(); // Lee la categoría del videojuego
                ...
                // Opción 2: Listar todos los videojuegos
                ...
                titulo = teclado2.nextLine(); // Lee el título actual del videojuego
                System.out.println("Escriba el nombre del nuevo título: ");
                nuevoTitulo = teclado2.nextLine(); // Lee el nuevo título del videojuego
                System.out.println("Escriba la nueva cantidad de jugadores: ");
                nuevaCantidadJugadores = teclado1.nextInt(); // Lee la nueva cantidad de jugadores
